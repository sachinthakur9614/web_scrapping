...
f1  = open("interior_designer_decorators3.csv", 'w+')
...
k =5700
count = 0
for i in range(0,21542):
    html = requests.get('https://www.houzz.in/professionals/searchDirectory?topicId=26677&query=Interior+Designers+%26amp%3B+Decorators&location=India&distance=0&sort=4&p='+str(k))
