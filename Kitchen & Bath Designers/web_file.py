...
f1  = open("kitchen_bath_designer2.csv", 'w')
...
for i in range(0,910):
    ...
    html = requests.get('https://www.houzz.in/professionals/searchDirectory?topicId=26687&query=Kitchen+%26amp%3B+Bath+Designers&location=India&distance=0&sort=4&p='+str(k))
