...
f1  = open("architects&buildingDesigners6.csv", 'w+')
...
k =2490
count = 0
for i in range(0,28625):

    html = requests.get('https://www.houzz.in/professionals/searchDirectory?topicId=26676&query=Architects+%26amp%3B+Building+Designers&location=India&distance=0&sort=4&p='+str(k))
